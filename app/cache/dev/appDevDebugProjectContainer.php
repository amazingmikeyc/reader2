...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['feedfactory'] = new \AppBundle\Entity\FeedFactory($this->get('predis'), $this->get('guzzle'));
    }
